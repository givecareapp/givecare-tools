...
const EXPORT_NOTE =
  ...
  'Hound `corpus.project` from src/assessments/instruments.ts (@givecare/tools). ' +
  'gc-tools owns this definition; downstream copies (gc-evals distribution records, ' +
  'gc-sms production runtime) gate against it. Do not hand-edit — run the owner Hound projection.'
