...
These groupings route follow-up. They are not validated cutoffs, not a clinical
risk stratification, and are not shown to caregivers. GC-SDOH instruments record
self-reported caregiver needs across the six domains; they are not validated
caregiver burden or well-being instruments, and no band converts them into one.
